...
<tr><td>Unencoded</td><td><p><pre>#ESAPI().encoder().encodeForHTML(form.input)#</pre></td></tr>
<tr><td>HTML Body (encodeForHTML)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForHTML(form.input))#</pre></p></td></tr>
<tr><td>HTML Attribute (encodeForHTMLAttribute)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForHTMLAttribute(form.input))#</pre></p></td></tr>
<tr><td>Javascript (encodeForJavascript)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForJavaScript(form.input))#</pre></p></td></tr>
<tr><td>VBScript (encodeForVBScript)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForVBScript(form.input))#</pre></p></td></tr>
<tr><td>CSS (encodeForCSS)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForCSS(form.input))#</pre></p></td></tr>
<tr><td>URL (encodeForURL)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForURL(form.input))#</pre></p></td></tr>
<tr><td>Base 64 (encodeForBase64)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForBase64(form.input.getBytes(), false))#</pre></p></td></tr>
<tr><td>LDAP (encodeForLDAP)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForLDAP(form.input))#</pre></p></td></tr>
<tr><td>Oracle (encodeForSQL) - discouraged use &lt;cfqueryparam&gt;</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForSQL(oracle, form.input))#</pre></p></td></tr>
<tr><td>MySQL (encodeForSQL) - discouraged use &lt;cfqueryparam&gt;</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForSQL(mysql, form.input))#</pre></p></td></tr>
<tr><td>MySQLAnsi (encodeForSQL) - discouraged use &lt;cfqueryparam&gt;</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForSQL(mysqlansi, form.input))#</pre></p></td></tr>
<tr><td>XML (encodeForXML)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForXML(form.input))#</pre></p></td></tr>
<tr><td>XML Attribute (encodeForXMLAttribute)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForXMLAttribute(form.input))#</pre></p></td></tr>
<tr><td>LDAP Distinguished Name (encodeForDN)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForDN(form.input))#</pre></p></td></tr>
<tr><td>XPath Query (encodeForXPath)</td><td><p><pre>#ESAPI().encoder().encodeForHTML(ESAPI().encoder().encodeForXPath(form.input))#</pre></p></td></tr>
</table>
</div>
