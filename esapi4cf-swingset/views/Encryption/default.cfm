...
<ul>
 <li><b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/Encryptor.html##decryptString()">java.lang.String decryptString(java.lang.String ciphertext)</a></b> 
         <br /> Decrypts the provided ciphertext string (encrypted with the encrypt method) and returns a plaintext string.</li> 
 <li><b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/Encryptor.html##encryptString()">java.lang.String encryptString(java.lang.String plaintext)</a></b> 
...
<ul>
	<li> <b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/reference/DefaultRandomizer.html##getRandomBoolean()">boolean getRandomBoolean()</a></b> 
	          Returns a random boolean. </li><br />	<br />
	          
	<li> <b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/reference/DefaultRandomizer.html##getRandomFilename()">String getRandomFilename(String extension)</a></b> 
	          Returns an unguessable random filename with the specified extension.</li><br /><br />
	
	<li> <b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/reference/DefaultRandomizer.html##getRandomGUID()">String getRandomGUID()</a></b>
	          Generates a random GUID. </li><br /><br />
	
	<li> <b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/reference/DefaultRandomizer.html##getRandomInteger()">int getRandomInteger(int min, int max)</a></b> 
	          Gets the random integer. </li><br /><br />
	
	<li> <b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/reference/DefaultRandomizer.html##getRandomLong()">long getRandomLong()</a></b> 
	          Gets the random long. </li><br /><br />
	
	<li> <b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/reference/DefaultRandomizer.html##getRandomReal()">float getRandomReal(float min, float max)</a></b> 
	          Gets the random real. </li><br /><br />
	
	<li> <b><a href="../esapi4cf-apiref/esapi4cf/org/owasp/esapi/reference/DefaultRandomizer.html##getRandomString()">String getRandomString(int length, char[] characterSet)</a></b> 
