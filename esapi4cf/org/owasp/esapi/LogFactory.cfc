 ...
 * @created 2008
 --->
<!---
 * The LogFactory interface is intended to allow substitution of various logging packages, while
 * providing a common interface to access them.
 *
 * In the reference implementation, JavaLogFactory.java implements this interface.
 * JavaLogFactory.java also contains an inner class called JavaLogger which implements Logger.java
 * and uses the Java logging package to log events.
 *
...
<cfinterface>
	...
	<cffunction access="public" returntype="esapi4cf.org.owasp.esapi.Logger" name="getLogger"
		...
		<cfargument required="true" type="String" name="moduleName"
		            hint="The name of the module requesting the logger."/>
