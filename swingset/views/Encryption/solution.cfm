...
<code>
application.ESAPI.encryptor().encryptString()<br/>
application.ESAPI.encryptor().decryptString()<br/>
</code>
<br/><br/>
...
<p>Encrypted Value: <cfif len(rc.decrypted)>#application.ESAPI.encryptor().encryptString(rc.decrypted)#</cfif></p>	
<p>Decrypted Value: <cfif len(rc.encrypted)>#application.ESAPI.encryptor().decryptString(rc.encrypted)#</cfif></p>
