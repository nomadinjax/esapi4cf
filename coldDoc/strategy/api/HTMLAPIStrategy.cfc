...
<cffunction name="run" hint="Run this strategy" access="public" returntype="void" output="false">
	...
	<cfscript>
		...
		args = {path=getOutputDir() & "/index.html", template="#variables.instance.static.TEMPLATE_PATH#/index.html", projectTitle=getProjectTitle()};
...
<cffunction name="writePackagePages" hint="writes the package summaries" access="private" returntype="void" output="false">
	...
	<cfoutput query="arguments.qMetaData" group="package">
		<cfscript>
			currentDir = getOutputDir() & "/" & replace(arguments.qMetaData.package, ".", "/", "all");
			ensureDirectory(currentDir);
			qPackage = getMetaSubquery(arguments.qMetaData, "package = '#arguments.qMetaData.package#'", "name asc");
			...
			writeTemplate(path=currentDir & "/package-summary.html",
						template="#variables.instance.static.TEMPLATE_PATH#/package-summary.html",
						projectTitle = getProjectTitle(),
						package = arguments.qMetaData.package,
						qClasses = qClasses,
						qInterfaces = qInterfaces);

			writeTemplate(path=currentDir & "/package-frame.html",
						template="#variables.instance.static.TEMPLATE_PATH#/package-frame.html",
						projectTitle = getProjectTitle(),
						package = arguments.qMetaData.package,
						qClasses = qClasses,
						qInterfaces = qInterfaces);
...
<!---	<cfif arguments.qPackage.package eq "coldspring.aop">
	...
	<cfloop query="arguments.qPackage">
		<cfscript>
			currentDir = getOutputDir() & "/" & replace(arguments.qPackage.package, ".", "/", "all");
			safeMeta = structCopy(arguments.qPackage.metadata);
			...
			writeTemplate(path=currentDir & "/#arguments.qPackage.name#.html",
						template="#variables.instance.static.TEMPLATE_PATH#/class.html",
						projectTitle = getProjectTitle(),
...
<cffunction name="writeOverviewSummaryAndFrame" hint="writes the overview-summary.html" access="private" returntype="void" output="false">
	...
	<cfscript>
		writeTemplate(path=getOutputDir() & "/overview-summary.html",
					template="#variables.instance.static.TEMPLATE_PATH#/overview-summary.html",
					projectTitle = getProjectTitle(),
					qPackages = qPackages);
		...
		writeTemplate(path=getOutputDir() & "/overview-frame.html",
					template="#variables.instance.static.TEMPLATE_PATH#/overview-frame.html",
					projectTitle=getProjectTitle(),
					qPackages = qPackages);
	</cfscript>
</cffunction>
...
<cffunction name="writeAllClassesFrame" hint="writes the allclasses-frame.html" access="private" returntype="void" output="false">
	...
	<cfscript>
		...
		writeTemplate(path=getOutputDir() & "/allclasses-frame.html",
					template="#variables.instance.static.TEMPLATE_PATH#/allclasses-frame.html",
					qMetaData = arguments.qMetaData);
	</cfscript>
</cffunction>

<cffunction name="getOutputDir" access="private" returntype="string" output="false">
	<cfreturn variables.instance.outputDir />
</cffunction>
...
<cffunction name="setOutputDir" access="private" returntype="void" output="false">
	...
	<cfset variables.instance.outputDir = arguments.outputDir />
</cffunction>

<cffunction name="getProjectTitle" access="private" returntype="string" output="false">
	<cfreturn variables.instance.projectTitle />
</cffunction>
...
<cffunction name="setProjectTitle" access="private" returntype="void" output="false">
	...
	<cfset variables.instance.projectTitle = arguments.projectTitle />
</cffunction>
