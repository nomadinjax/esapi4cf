...
<cfscript>
	...
	results = createObject("component", "mxunit.runner.DirectoryTestSuite").run(directory=expandPath("."), componentPath="test.automation", recurse=true, excludes="test.automation.org.owasp.esapi.util.TestCase");
</cfscript>
