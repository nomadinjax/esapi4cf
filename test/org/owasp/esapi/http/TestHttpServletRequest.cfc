...
<cfcomponent extends="org.owasp.esapi.util.Object" output="false">
	...
	<cffunction access="public" returntype="void" name="removeParameter" output="false" hint="removeParameter removes the parameter name from the parameters map if it exists">
