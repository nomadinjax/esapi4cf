...
<cfcomponent extends="cfesapi.org.owasp.esapi.lang.Object" implements="cfesapi.org.owasp.esapi.HttpServletRequest" output="false">
	...
	<cfscript>
		...
		instance.requestDispatcher = newComponent("cfesapi.test.org.owasp.esapi.http.MockRequestDispatcher").init();
	...
	<cffunction access="public" returntype="void" name="removeParameter" output="false"
	            hint="removes the parameter name from the parameters map if it exists">
	...
	<cffunction access="public" returntype="void" name="addHeader" output="false"
		...
		<cfscript>
			if(structKeyExists(instance.headers, arguments.name)) {
				local.values = instance.headers.get(arguments.name);
			}
	...
	<cffunction access="public" returntype="void" name="setHeader" output="false"
	            hint="Set a header replacing any previous value(s).">
	...
	<cffunction access="public" returntype="Array" name="getHeaderNames" output="false"
	            hint="Enumeration of header names as strings">
	...
	<cffunction access="public" returntype="void" name="setQueryString" output="false"
	            hint="Set the query string to return.">
	...
	<cffunction access="public" returntype="any" name="getRequestURL" output="false"
	            hint="java.lang.StringBuffer">

		<cfscript>
			return newComponent("cfesapi.org.owasp.esapi.lang.StringBuilder").init(getScheme() & "://" & getServerName() & getRequestURI() & "?" & getQueryString());
		</cfscript>
	...
	<cffunction access="public" returntype="any" name="getSession" output="false"
	            hint="cfesapi.org.owasp.esapi.HttpSession">
		...
		<cfscript>
			if(structKeyExists(arguments, "create")) {
				if(!isObject(instance.session) && arguments.create) {
					instance.session = newComponent("cfesapi.test.org.owasp.esapi.http.MockHttpSession").init();
				}
	...
	<cffunction access="public" returntype="any" name="getInputStream" output="false"
	            hint="javax.servlet.ServletInputStream">

		<cfscript>
			return newJava("MockServletInputStream").init(instance.body);
		</cfscript>
	...
	<cffunction access="public" returntype="any" name="getRequestDispatcher" output="false"
	            hint="javax.servlet.RequestDispatcher">
	...
	<cffunction access="public" returntype="boolean" name="isMultipartContent" output="false">
		...
		<cfscript>
			...
			if(structKeyExists(local, "contentTypes")) {
