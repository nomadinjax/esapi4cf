...
<cfcomponent extends="esapi4cf.test.org.owasp.esapi.util.TestCase" output="false">
	...
	<cffunction access="public" returntype="void" name="testSetLevel" output="false" hint="Test of setLevel method of the inner class org.owasp.esapi.reference.JavaLogFactory$JavaLogger that is defined in org.owasp.esapi.reference.JavaLogFactory.">
		<cfscript>
			// CF8 requires 'var' at the top
			var newLogger = "";
	...
	<cffunction access="public" returntype="void" name="testInfo" output="false" hint="Test of info method, of class org.owasp.esapi.Logger.">
		<cfscript>
			...
			variables.testLogger.info( getSecurity("SECURITY_SUCCESS"), true, "test message" );
			variables.testLogger.info( getSecurity("SECURITY_SUCCESS"), true, "test message", "" );
			variables.testLogger.info( getSecurity("SECURITY_SUCCESS"), true, "%3escript%3f test message", "" );
			variables.testLogger.info( getSecurity("SECURITY_SUCCESS"), true, "<script> test message", "" );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="testTrace" output="false" hint="Test of trace method, of class org.owasp.esapi.Logger.">
		<cfscript>
			...
			variables.testLogger.trace( getSecurity("SECURITY_SUCCESS"), true, "test message" );
			variables.testLogger.trace( getSecurity("SECURITY_SUCCESS"), true, "test message", "" );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="testDebug" output="false" hint="Test of debug method, of class org.owasp.esapi.Logger.">
		<cfscript>
			...
			variables.testLogger.debug( getSecurity("SECURITY_SUCCESS"), true, "test message" );
			variables.testLogger.debug( getSecurity("SECURITY_SUCCESS"), true, "test message", "" );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="testError" output="false" hint="Test of error method, of class org.owasp.esapi.Logger.">
		<cfscript>
			...
			variables.testLogger.error( getSecurity("SECURITY_SUCCESS"), true, "test message" );
			variables.testLogger.error( getSecurity("SECURITY_SUCCESS"), true, "test message", "" );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="testWarning" output="false" hint="Test of warning method, of class org.owasp.esapi.Logger.">
		<cfscript>
			...
			variables.testLogger.warning( getSecurity("SECURITY_SUCCESS"), true, "test message" );
			variables.testLogger.warning( getSecurity("SECURITY_SUCCESS"), true, "test message", "" );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="testFatal" output="false" hint="Test of fatal method, of class org.owasp.esapi.Logger.">
		<cfscript>
			...
			variables.testLogger.fatal( getSecurity("SECURITY_SUCCESS"), true, "test message" );
			variables.testLogger.fatal( getSecurity("SECURITY_SUCCESS"), true, "test message", "" );
		</cfscript> 
	</cffunction>
