 ...
 * @created 2011
 */ --->
<cfcomponent displayname="EncoderTest" extends="cfesapi.test.org.owasp.esapi.lang.TestCase" output="false" hint="The Class EncoderTest.">
	...
	<cffunction access="public" returntype="void" name="testCanonicalize" output="false"
		...
		<cfscript>
			...
			local.encoder = newComponent("cfesapi.org.owasp.esapi.reference.DefaultEncoder").init(instance.ESAPI, local.js);
			newJava("java.lang.System").out.println("JavaScript Decoding");

			/* NULL test not valid in CF
			assertEquals(chr(0), local.encoder.canonicalize("\0"));
			*/
			...
			local.encoder = newComponent("cfesapi.org.owasp.esapi.reference.DefaultEncoder").init(instance.ESAPI, local.css);
	...
	<cffunction access="public" returntype="void" name="testDoubleEncodingCanonicalization" output="false"
		...
		<cfscript>
			...
			assertEquals("< < < < < < <", local.encoder.canonicalize("%26lt; %26lt; &##X25;3c &##x25;3c %2526lt%253B %2526lt%253B %2526lt%253B", false, false));
	...
	<cffunction access="public" returntype="void" name="testMySQLANSIModeQuoteInjection" output="false">
		...
		<cfscript>
			...
			assertEquals(" or 1=1 -- -", local.encoder.encodeForSQL(local.c, '" or 1=1 -- -'), "MySQL Ansi Quote Injection Bug");
		</cfscript>
	...
	<cffunction access="public" returntype="void" name="testWindowsCodec" output="false"
	            hint="Test of WindowsCodec">
		<cfset var local = {}/>
		...
		<cfscript>
			...
			//assertEquals(null, local.win.decodeCharacter(local.npbs));
			local.decodeTest = local.win.decodeCharacter(local.npbs);
			assertTrue(!structKeyExists(local, "decodeTest"));

			local.epbs = newJava("org.owasp.esapi.codecs.PushbackString").init("");
			//assertEquals(null, local.win.decodeCharacter(local.epbs));
			local.decodeTest = local.win.decodeCharacter(local.epbs);
			assertTrue(!structKeyExists(local, "decodeTest"));
	...
	<cffunction access="public" returntype="void" name="testUnixCodec" output="false"
	            hint="Test of UnixCodec">
		<cfset var local = {}/>
		...
		<cfscript>
			...
			local.npbs = newJava("org.owasp.esapi.codecs.PushbackString").init("n");
			//assertEquals(null, local.unix.decodeCharacter(local.npbs));
			local.decodeTest = local.unix.decodeCharacter(local.npbs);
			assertTrue(!structKeyExists(local, "decodeTest"));
			...
			local.epbs = newJava("org.owasp.esapi.codecs.PushbackString").init("");
			//assertEquals(null, local.unix.decodeCharacter(local.epbs));
			local.decodeTest = local.unix.decodeCharacter(local.epbs);
			assertTrue(!structKeyExists(local, "decodeTest"));
	...
	<cffunction access="public" returntype="void" name="testConcurrency" output="false">
		...
		<cfscript>
			newJava("java.lang.System").out.println("Encoder Concurrency");
		</cfscript>

		<cfloop index="local.i" from="1" to="10">
			<cfthread action="run" name="#local.i#">

				<cfscript>
					newComponent("EncoderTest$EncoderConcurrencyMock").init(local.i).run();
				</cfscript>
