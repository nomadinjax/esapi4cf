 ...
 * @created 2011
 */ --->
<cfcomponent displayname="ExecutorTest" extends="cfesapi.test.org.owasp.esapi.lang.TestCase" output="false" hint="The Class ExecutorTest.">
	...
	<cffunction access="public" returntype="void" name="testExecuteWindowsSystemCommand" output="false"
	            hint="Test of executeOSCommand method, of class org.owasp.esapi.Executor">
		<cfset var local = {}/>
		...
		<cfscript>
			...
			local.conf = newComponent("cfesapi.test.org.owasp.esapi.reference.ExecutorTest$Conf").init(instance.ESAPI.securityConfiguration(), listToArray(local.cmd.getPath()), local.tmpDir);
	...
	<cffunction access="public" returntype="void" name="testExecuteUnixSystemCommand" output="false"
		...
		<cfscript>
			...
			local.conf = newComponent("Conf").init(instance.ESAPI.securityConfiguration(), Collections.singletonList(local.binSh.getPath()), JavaFile.init("/tmp"));
			instance.ESAPI.override(local.conf);
