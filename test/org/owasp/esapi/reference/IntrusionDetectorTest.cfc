...
<cfcomponent extends="cfesapi.test.org.owasp.esapi.lang.TestCase" output="false">
	...
	<cffunction access="public" returntype="void" name="testAddException" output="false" hint="Test of addException method, of class org.owasp.esapi.IntrusionDetector.">
		<cfscript>
			...
			instance.ESAPI.intrusionDetector().addException( new cfesapi.org.owasp.esapi.errors.ValidationException(instance.ESAPI, "user message", "log message") );
			instance.ESAPI.intrusionDetector().addException( new cfesapi.org.owasp.esapi.errors.IntrusionException(instance.ESAPI, "user message", "log message") );
