 ...
 * @created 2011
 */ --->
<cfcomponent displayname="AuthenticatorTest" extends="cfesapi.test.org.owasp.esapi.lang.TestCase" output="false" hint="The Class AuthenticatorTest.">
	...
	<cffunction access="public" returntype="void" name="testGenerateStrongPassword" output="false"
		...
		<cfscript>
			...
			local.user = newComponent("cfesapi.org.owasp.esapi.reference.DefaultUser").init(instance.ESAPI, local.username);
