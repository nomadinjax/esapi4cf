...
<cfcomponent extends="esapi4cf.test.org.owasp.esapi.util.TestCase" output="false">
	...
	<cffunction access="private" returntype="org.owasp.esapi.reference.DefaultUser" name="createTestUser" output="false" hint="Creates the test user.">
	...
	<cffunction access="public" type="void" name="testAddRole" output="false" hint="Test of testAddRole method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" type="void" name="testAddRoles" output="false" hint="Test of addRoles method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.authenticator();
	...
	<cffunction access="public" type="void" name="testChangePassword" output="false" hint="Test of changePassword method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var oldPassword = "";
	...
	<cffunction access="public" type="void" name="testDisable" output="false" hint="Test of disable method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.authenticator();
			var oldPassword = instance.generateStrongPassword();
	...
	<cffunction access="public" type="void" name="testEnable" output="false" hint="Test of enable method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.authenticator();
			var oldPassword = instance.generateStrongPassword();
	...
	<cffunction access="public" type="void" name="testFailedLoginLockout" output="false" hint="Test of failedLoginCount lockout, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
			var httpRequest = "";
	...
	<cffunction access="public" type="void" name="testGetAccountName" output="false" hint="Test of getAccountName method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" type="void" name="testGetLastFailedLoginTime" output="false" hint="Test get last failed login time.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.authenticator();
			var oldPassword = instance.generateStrongPassword();
	...
	<cffunction access="public" type="void" name="testGetLastLoginTime" output="false" hint="Test get last login time.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var oldPassword = "";
	...
	<cffunction access="public" type="void" name="testGetLastPasswordChangeTime" output="false" hint="Test getLastPasswordChangeTime method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
			var t1 = "";
	...
	<cffunction access="public" type="void" name="testGetRoles" output="false" hint="Test of getRoles method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var accountName = "";
	...
	<cffunction access="public" type="void" name="testGetScreenName" output="false" hint="Test of getScreenName method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
			var screenName = "";
	...
	<cffunction access="public" type="void" name="testGetSessions" output="false" hint="">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var accountName = "";
	...
	<cffunction access="public" type="void" name="testIncrementFailedLoginCount" output="false" hint="Test of incrementFailedLoginCount method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
			var httpRequest = "";
	...
	<cffunction access="public" type="void" name="testIsEnabled" output="false" hint="Test of isEnabled method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
	...
	<cffunction access="public" type="void" name="testIsInRole" output="false" hint="Test of isInRole method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
			var role = "";
	...
	<cffunction access="public" type="void" name="testIsLocked" output="false" hint="Test of isLocked method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
	...
	<cffunction access="public" type="void" name="testIsSessionAbsoluteTimeout" output="false" hint="Test of isSessionAbsoluteTimeout method, of class org.owasp.esapi.IntrusionDetector.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var oldPassword = "";
	...
	<cffunction access="public" type="void" name="testIsSessionTimeout" output="false" hint="Test of isSessionTimeout method, of class org.owasp.esapi.IntrusionDetector.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var oldPassword = "";
	...
	<cffunction access="public" type="void" name="testLock" output="false" hint="Test of lockAccount method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var oldPassword = "";
	...
	<cffunction access="public" type="void" name="testLoginWithPassword" output="false" hint="Test of loginWithPassword method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var httpRequest = "";
			var httpResponse = "";
	...
	<cffunction access="public" type="void" name="testLogout" output="false" hint="Test of logout method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var httpRequest = "";
			var httpResponse = "";
	...
	<cffunction access="public" type="void" name="testRemoveRole" output="false" hint="Test of testRemoveRole method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var role = "";
			var user = "";
	...
	<cffunction access="public" type="void" name="testResetCSRFToken" output="false" hint="Test of testResetCSRFToken method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" type="void" name="testSetAccountName" output="false" hint="Test of setAccountName method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" type="void" name="testSetExpirationTime" output="false" hint="Test of setExpirationTime method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" type="void" name="testSetRoles" output="false" hint="Test of setRoles method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var user = "";
			var set = "";
	...
	<cffunction access="public" type="void" name="testSetScreenName" output="false" hint="Test of setScreenName method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" type="void" name="testUnlock" output="false" hint="Test of unlockAccount method, of class org.owasp.esapi.User.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.authenticator();
			var oldPassword = instance.generateStrongPassword();
