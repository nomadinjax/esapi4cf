...
<cfcomponent extends="esapi4cf.test.org.owasp.esapi.util.TestCase" output="false">
	...
	<cffunction access="public" returntype="void" name="testIsValidHTTPRequest" output="false" hint="Test of isValidHTTPRequest method, of class org.owasp.esapi.HTTPUtilities.">
		<cfscript>
			// CF8 requires 'var' at the top
			var httpRequest = "";
			var list = "";
	...
	<cffunction access="public" returntype="void" name="testGetStateFromEncryptedCookie" output="false" hint="">
		<cfscript>
			// CF8 requires 'var' at the top
			var httpRequest = "";
			var httpResponse = "";
	...
	<cffunction access="public" returntype="void" name="testSaveStateInEncryptedCookie" output="false" hint="">
		<cfscript>
			// CF8 requires 'var' at the top
			var httpRequest = "";
			var httpResponse = "";
