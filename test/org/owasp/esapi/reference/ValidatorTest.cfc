 ...
 * @created 2011
 */ --->
<cfcomponent displayname="ValidatorTest" extends="cfesapi.test.org.owasp.esapi.lang.TestCase" output="false" hint="The Class ValidatorTest.">
	...
	<cffunction access="public" returntype="void" name="testAddRule" output="false">
		...
		<cfscript>
			...
			local.rule = newComponent("cfesapi.org.owasp.esapi.reference.validation.StringValidationRule").init(instance.ESAPI, "ridiculous");
	...
	<cffunction access="public" returntype="void" name="testAssertValidFileUpload" output="false">
	...
	<cffunction access="public" returntype="void" name="testGetPrintable1" output="false">
	...
	<cffunction access="public" returntype="void" name="testGetPrintable2" output="false">
	...
	<cffunction access="public" returntype="void" name="testGetRule" output="false">
		...
		<cfscript>
			local.validator = instance.ESAPI.validator();
			local.rule = newComponent("cfesapi.org.owasp.esapi.reference.validation.StringValidationRule").init(instance.ESAPI, "rule");
			local.validator.addRule(local.rule);
			assertEquals(local.rule, local.validator.getRule("rule"));
			assertFalse(local.rule.toStringESAPI() == local.validator.getRule("ridiculous").toStringESAPI());
		</cfscript>
	...
	<cffunction access="public" returntype="void" name="testLenientDate" output="false">
		...
		<cfscript>
			...
			try {
				...
				local.validator = instance.ESAPI.validator();
				local.lenientDateTest = local.validator.getValidDate("datatest3-lenient", "15/2/2009 11:83:00", newJava("java.text.DateFormat").getDateInstance(newJava("java.text.DateFormat").SHORT, newJava("java.util.Locale").US), false);
				...
				// FIXME: we cannot verify this because getCause() is null
	...
	<cffunction access="public" returntype="void" name="testGetValidDirectoryPath" output="false">
		...
		<cfscript>
			...
			local.validator.getValidDirectoryPath("dirtest2", null, local.parent, false, local.errors);
			assertEquals(1, local.errors.size());
			*/
	...
	<cffunction access="public" returntype="void" name="testGetValidDouble" output="false">
		...
		<cfscript>
			...
			local.validator.getValidDouble("dtest2", null, 0, 20, true, local.errors);
			assertEquals(0, local.errors.size());
			local.validator.getValidDouble("dtest3", null, 0, 20, false, local.errors);
			assertEquals(1, local.errors.size());
			*/
	...
	<cffunction access="public" returntype="void" name="testGetValidSafeHTML" output="false">
		...
		<cfscript>
			...
			local.rule = newComponent("cfesapi.org.owasp.esapi.reference.validation.HTMLValidationRule").init(instance.ESAPI, "test");
	...
	<cffunction access="public" returntype="void" name="testIsValidDirectoryPath" output="false">
		...
		<cfscript>
			...
			local.encoder = newComponent("cfesapi.org.owasp.esapi.reference.DefaultEncoder").init(instance.ESAPI, local.list);
			local.validator = newComponent("cfesapi.org.owasp.esapi.reference.DefaultValidator").init(instance.ESAPI, local.encoder);
			...
			if(local.isWindows) {
				...
				assertFalse(local.validator.isValidDirectoryPath("test", "/etc/config", local.parent, false));
				...
				assertTrue(local.errors.size() == 3);
				assertTrue(local.validator.isValidDirectoryPath("test5", local.sysRoot, local.parent, false, local.errors));// Windows always exist directory
				assertTrue(local.errors.size() == 3);
				assertFalse(local.validator.isValidDirectoryPath("test6", local.sysRoot & "\System32\cmd.exe", local.parent, false, local.errors));// Windows command shell
				assertTrue(local.errors.size() == 4);
	...
	<cffunction access="public" returntype="void" name="testIsValidDouble" output="false">
		...
		<cfscript>
			...
			//testing null value
			/* NULL tests invalid for CF
			assertTrue(local.validator.isValidDouble("test3", null, -10, 10, true, local.errors));
			assertTrue(local.errors.size() == 1);
			assertFalse(local.validator.isValidDouble("test4", null, -10, 10, false, local.errors));
			assertTrue(local.errors.size() == 2);
			*/
	...
	<cffunction access="public" returntype="void" name="testIsValidInteger" output="false">
		...
		<cfscript>
			...
			*/
			...
			//testing null value
			/* NULL test invalid for CF
			assertTrue(local.validator.isValidInteger("test3", null, -10, 10, true, local.errors));
			assertTrue(local.errors.size() == 1);
			assertFalse(local.validator.isValidInteger("test4", null, -10, 10, false, local.errors));
			assertTrue(local.errors.size() == 2);
			*/
			//testing empty string
	...
	<cffunction access="public" returntype="void" name="testIsValidNumber" output="false">
		...
		<cfscript>
			...
			*/
			...
			//testing null value
			/* NULL tests invalid for CF
			assertTrue(local.validator.isValidNumber("test3", null, -10, 10, true, local.errors));
			assertTrue(local.errors.size() == 1);
			assertFalse(local.validator.isValidNumber("test4", null, -10, 10, false, local.errors));
			assertTrue(local.errors.size() == 2);
			*/
			//testing empty string
	...
	<cffunction access="public" returntype="void" name="testIsValidPrintable" output="false">
		...
		<cfscript>
			...
			local.charArray = [inputBaseN("08", 16)];
			assertFalse(local.validator.isValidPrintable("name", local.charArray, 100, false));
			...
			assertTrue(local.errors.size() == 0);
			assertFalse(local.validator.isValidPrintable("name3", local.chars, 100, false, local.errors));
			assertTrue(local.errors.size() == 1);
	...
	<cffunction access="public" returntype="void" name="testGetParameter" output="false">
		...
		<cfscript>
			...
			for(local.i = 1; local.i <= 4; local.i++) {
				assertTrue(local.safeRequest.getParameter("p" & local.i) == local.request.getParameter("p" & local.i));
			}
	...
	<cffunction access="public" returntype="void" name="testGetCookies" output="false">
		...
		<cfscript>
			...
			local.requestCookies = local.request.getCookies();
			assertEquals(local.cookies[1].getValue(), local.requestCookies[1].getValue());
			assertEquals(local.cookies[2].getName(), local.requestCookies[3].getName());
	...
	<cffunction access="public" returntype="void" name="testGetQueryString" output="false">
		...
		<cfscript>
			...
			local.request = newComponent("cfesapi.test.org.owasp.esapi.http.MockHttpServletRequest").init();
			local.safeRequest = newComponent("cfesapi.org.owasp.esapi.filters.SecurityWrapperRequest").init(instance.ESAPI, local.request);
			local.request.setQueryString("mail=bob@alice.com&passwd=" & arrayToList(newJava("org.owasp.esapi.EncoderConstants").CHAR_PASSWORD_SPECIALS, ""));// TODO, fix this + "&special=�����");
	...
	<cffunction access="private" returntype="String" name="generateStringOfLength" output="false">
		...
		<cfscript>
			local.longString = newComponent("cfesapi.org.owasp.esapi.lang.StringBuilder").init();
			for(local.i = 0; local.i < arguments.length; local.i++) {
				local.longString.append("a");
			}
			return local.longString.toStringESAPI();
		</cfscript>
