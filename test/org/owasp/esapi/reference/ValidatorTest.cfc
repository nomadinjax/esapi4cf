...
<cfcomponent extends="cfesapi.test.TestCase" output="false">
	...
	<cffunction access="public" returntype="void" name="testGetValidDate" output="false">
		<cfscript>
			...
			local.validator = instance.ESAPI.validator();
			local.errors = createObject("component", "cfesapi.org.owasp.esapi.ValidationErrorList");
			assertTrue(local.validator.getValidDate("datetest1", "June 23, 1967", DateFormat.getDateInstance(DateFormat.MEDIUM, Locale.US), false) != "");
			local.validator.getValidDate("datetest2", "freakshow", DateFormat.getDateInstance(), false, local.errors);
			assertEquals(1, local.errors.size());
	...
	<cffunction access="public" returntype="void" name="testGetValidDouble" output="false">
		<cfscript>
			...
			assertEquals(2, local.errors.size());
			local.validator.getValidDouble("dtest5", "" & (Double.MAX_VALUE), 0, 20, true, local.errors);
	...
	<cffunction access="public" returntype="void" name="testIsValidDirectoryPath" output="false">
		<cfscript>
			...
			local.validator = createObject("component", "cfesapi.org.owasp.esapi.reference.DefaultValidator").init(instance.ESAPI, local.encoder);
	...
	<cffunction access="private" returntype="String" name="generateStringOfLength" output="false">
		...
		<cfscript>
	        local.longString = createObject("java", "java.lang.StringBuilder").init();
