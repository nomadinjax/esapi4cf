...
<cfcomponent extends="esapi4cf.test.org.owasp.esapi.util.TestCase" output="false">
	...
	<cffunction access="public" returntype="void" name="testIsValidCreditCard" output="false" hint="Test of isValidCreditCard method, of class org.owasp.esapi.Validator.">
		<cfscript>
	...
	<cffunction access="public" returntype="void" name="testIsValidInput" output="false" hint="Test of isValidEmailAddress method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testIsValidSafeHTML" output="false" hint="Test of isValidSafeHTML method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testGetValidSafeHTML" output="false" hint="Test of getValidSafeHTML method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = "";
			var test1 = "";
	...
	<cffunction access="public" returntype="void" name="testIsValidListItem" output="false" hint="Test of isValidListItem method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
			var list = [];
	...
	<cffunction access="public" returntype="void" name="testIsValidNumber" output="false" hint="Test of isValidNumber method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testIsValidInteger" output="false" hint="">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testGetValidDate" output="false" hint="Test of getValidDate method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testIsValidFileName" output="false" hint="Test of isValidFileName method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testIsValidDirectoryPath" output="false" hint="Test of isValidDirectoryPath method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" returntype="void" name="testIsValidPrintable" output="false" hint="">
		<cfscript>
			// CF8 requires 'var' at the top
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testIsValidFileContent" output="false" hint="Test of isValidFileContent method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
	...
	<cffunction access="public" returntype="void" name="testIsValidFileUpload" output="false" hint="Test of isValidFileUpload method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var isWindows = iif( System.getProperty( "os.name" ).indexOf( "Windows" ) != -1, de( true ), de( false ) );
			var instance = variables.ESAPI.validator();
	...
	<cffunction access="public" returntype="void" name="testIsValidParameterSet" output="false" hint="Test of isValidParameterSet method, of class org.owasp.esapi.Validator.">
		<cfscript>
			// CF8 requires 'var' at the top
			var requiredNames = "";
			var optionalNames = "";
	...
	<cffunction access="public" returntype="void" name="testSafeReadLine" output="false" hint="Test safe read line.">
		<cfscript>
			// CF8 requires 'var' at the top
			var s = "";
			var instance = "";
