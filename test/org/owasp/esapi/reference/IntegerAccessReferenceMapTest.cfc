...
<cfcomponent extends="esapi4cf.test.org.owasp.esapi.util.TestCase" output="false">
	...
	<cffunction access="public" returntype="void" name="testUpdate" output="false">
		...
		<cfscript>
			...
			arm = createObject("component", "org.owasp.esapi.reference.IntegerAccessReferenceMap").init(request.ESAPI);
	...
	<cffunction access="public" returntype="void" name="testGetIndirectReference" output="false">
		...
		<cfscript>
			...
			list.add("345");
			instance = createObject("component", "org.owasp.esapi.reference.IntegerAccessReferenceMap").init(request.ESAPI, list);
