...
<cfcomponent extends="org.owasp.esapi.util.Object" output="false" hint="Utilities to help with tests that involve files or directories.">
	...
	<cffunction access="public" returntype="boolean" name="isChildSubDirectory" output="false" hint="Checks that child is a directory and really a child of parent. This verifies that the {@link File##getCanonicalFile() canonical} child is actually a child of parent. This should fail if the child is a symbolic link to another directory and therefore should not be traversed in a recursive traversal of a directory.">
	...
	<cffunction access="public" returntype="void" name="delete" output="false" hint="Delete a file. Unlinke {@link File##delete()}, this throws an exception if deletion fails.">
