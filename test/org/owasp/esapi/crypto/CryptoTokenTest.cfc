 ...
 * @created 2011
 */
component CryptoTokenTest extends="cfesapi.test.org.owasp.esapi.lang.TestCase" {
	...
	public void function testCryptoToken() {
	...
	public void function testCryptoTokenSecretKey() {
		// Test with default CTOR
	...
	private void function CTORtest(required cfesapi.org.owasp.esapi.crypto.CryptoToken ctok, sk) {
		local.token = "";
		try {
	...
	public void function testCryptoTokenSecretKeyString() {
	...
	public void function testExpiration() {
		local.ctok = new cfesapi.org.owasp.esapi.crypto.CryptoToken(ESAPI=instance.ESAPI);
	...
	public void function testSetUserAccountName() {
		local.ctok = new cfesapi.org.owasp.esapi.crypto.CryptoToken(ESAPI=instance.ESAPI);
		try {
	...
	public void function testSetExpirationDate() {
		local.ctok = new cfesapi.org.owasp.esapi.crypto.CryptoToken(ESAPI=instance.ESAPI);
	...
	public void function testSetAndGetAttribute() {
		local.ctok = new cfesapi.org.owasp.esapi.crypto.CryptoToken(ESAPI=instance.ESAPI);
	...
	public void function tesAddandGetAttributes() {
		local.ctok = new cfesapi.org.owasp.esapi.crypto.CryptoToken(ESAPI=instance.ESAPI);
		local.origAttrs = "";
	...
	private void function nap(required numeric n) {
		try {
