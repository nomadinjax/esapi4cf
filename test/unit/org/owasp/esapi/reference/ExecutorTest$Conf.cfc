 ...
 */
--->
<cfcomponent extends="esapi4cf.test.unit.org.owasp.esapi.SecurityConfigurationWrapper" output="false" hint="Config wrapper to temporarly set the allowedExecutables and workingDirectory.">
