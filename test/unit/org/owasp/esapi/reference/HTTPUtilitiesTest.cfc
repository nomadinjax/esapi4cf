...
<cfcomponent extends="esapi4cf.test.unit.org.owasp.esapi.util.TestCase" output="false">
	...
	<cffunction access="public" returntype="void" name="testGetFileUploads" output="false"
		...
		<cfscript>
			...
			dir = createObject("component", "esapi4cf.test.unit.org.owasp.esapi.util.FileTestUtils").createTmpDirectory(prefix=variables.CLASS_NAME);
			...
			createObject("component", "esapi4cf.test.unit.org.owasp.esapi.util.FileTestUtils").deleteRecursively(dir);
		</cfscript>
