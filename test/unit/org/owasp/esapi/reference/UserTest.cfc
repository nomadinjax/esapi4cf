...
<cfcomponent extends="esapi4cf.test.unit.org.owasp.esapi.util.TestCase" output="false">
	...
	<cffunction access="public" type="void" name="testGetLastFailedLoginTime" output="false"
		...
		<cfscript>
			...
			var oldPassword = instance.generateStrongPassword();
			var user = createTestUser(oldPassword);
			var httpRequest = createObject("java", "org.owasp.esapi.http.TestHttpServletRequest").init();
			var httpResponse = createObject("java", "org.owasp.esapi.http.TestHttpServletResponse").init();
