				...
				'<ul class="nav navbar-nav navbar-right">'
					+ '<li class="dropdown">'
						...
						+ '<ul class="dropdown-menu">'
							...
							+ '<li><a href="https://github.com/damonmiller/esapi4cf/archive/v1.1.0a.zip">.zip file</a></li>'
							+ '<li><a href="https://github.com/damonmiller/esapi4cf/archive/v1.1.0a.tar.gz">.tar.gz file</a></li>'
						+ '</ul>'
					+ '</li>'
				+ '</ul>'
			);
