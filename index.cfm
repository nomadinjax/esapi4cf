...
<html>
	...
	<body>
		...
		<h2>Documentation</h2>
		<dl>
			<dt><a href="esapi4cf-swingset/">The ESAPI Swingset is a web application which demonstrates the many uses of the Enterprise Security API (ESAPI).</a></dt>
			...
			<dt><a href="esapi4cf-apiref/">ESAPI4CF API Documentation</a></dt>
			<dd>Technical documentation for the ESAPI4CF library.</dd>
		</dl>
		<h2>Tests</h2>
		<dl>
			<dt><a href="esapi4cf-test/org/owasp/esapi/AllTests.cfm">ESAPI4CF Unit Tests</a></dt>
			<dd>The ESAPI Unit Tests ported into ColdFusion/CFML using MXUnit (not included).</dd>
		</dl>
		<h2>Utilities</h2>
		<dl>
			<dt><a href="esapi4cf-utilities/DefaultEncryptedProperties.cfm">Encrypted Properties files</a></dt>
			...
			<dt><a href="esapi4cf-utilities/FileBasedAuthenticator.cfm">Fail safe main program to add or update an account in an emergency</a></dt>
