...
<cfcomponent implements="org.owasp.esapi.util.HttpServletResponse" extends="org.owasp.esapi.util.Object" output="false" hint="This response wrapper simply overrides unsafe methods in the HttpServletResponse API with safe versions.">
	...
	<cffunction access="public" returntype="org.owasp.esapi.util.HttpServletResponse" name="init" output="false"
	...
	<cffunction access="public" returntype="void" name="addSafeCookie" output="false"
		...
		<cfscript>
			...
			try {
				cookieName = variables.ESAPI.validator().getValidInput("safeAddCookie", arguments.name, "HTTPCookieName", 50, false);
				cookieValue = variables.ESAPI.validator().getValidInput("safeAddCookie", arguments.value, "HTTPCookieValue", 5000, false);
				...
				variables.logger.warning(getSecurity("SECURITY_FAILURE"), false, "Attempt to set invalid cookie denied", e);
			}
		</cfscript>
