...
<cfcomponent extends="cfesapi.org.owasp.esapi.lang.Object" implements="cfesapi.org.owasp.esapi.HttpServletRequest" output="false">
	...
	<cffunction access="public" returntype="SecurityWrapperRequest" name="init" output="false"
	...
	<cffunction access="package" returntype="any" name="getHttpServletRequest" output="false"
	            hint="javax.servlet.http.HttpServletRequest">
	...
	<cffunction access="public" returntype="Array" name="getAttributeNames" output="false"
	            hint="An Enumeration of attribute names.">
		<cfset var local = {}/>
	...
	<cffunction access="public" returntype="String" name="getCharacterEncoding" output="false"
	            hint="The character-encoding for this HttpServletRequest">
	...
	<cffunction access="public" returntype="numeric" name="getContentLength" output="false"
	            hint="The content-length for this HttpServletRequest">
	...
	<cffunction access="public" returntype="String" name="getContentType" output="false"
	            hint="The content-type for this HttpServletRequest">
	...
	<cffunction access="public" returntype="String" name="getContextPath" output="false"
		...
		<cfscript>
			...
			if(!structKeyExists(local, "path") || trim(local.path == "")) {
				return "";
			}
	...
	<cffunction access="public" returntype="numeric" name="getDateHeader" output="false"
	            hint="a long value representing the date specified in the header expressed as the number of milliseconds since January 1, 1970 GMT, or -1 if the named header was not included with the request.">
	...
	<cffunction access="public" returntype="any" name="getInputStream" output="false"
	            hint="The javax.servlet.ServletInputStream associated with this HttpServletRequest. Note that this input stream may contain attacks and the developer is responsible for canonicalizing, validating, and encoding any data from this stream.">
	...
	<cffunction access="public" returntype="numeric" name="getIntHeader" output="false"
	            hint="Returns the value of the specified request header as an int.">
		<cfargument type="String" name="name" required="true" hint="The name of an HTTP request header."/>
	...
	<cffunction access="public" returntype="String" name="getLocalAddr" output="false"
	            hint="A String containing the IP address on which the request was received.">
	...
	<cffunction access="public" returntype="any" name="getLocaleESAPI" output="false"
	            hint="java.util.Locale: The preferred Locale for the client.">
	...
	<cffunction access="public" returntype="Array" name="getLocales" output="false"
	            hint="An Enumeration of preferred Locale objects for the client.">
	...
	<cffunction access="public" returntype="String" name="getLocalName" output="false"
	            hint="A String containing the host name of the IP on which the request was received.">
	...
	<cffunction access="public" returntype="numeric" name="getLocalPort" output="false"
	            hint="Returns the Internet Protocol (IP) port number of the interface on which the request was received.">
	...
	<cffunction access="public" returntype="String" name="getMethod" output="false"
	            hint="Returns the name of the HTTP method with which this request was made.">
	...
	<cffunction access="public" returntype="String" name="getPathTranslated" output="false"
	            hint="Returns any extra path information, appropriate scrubbed, after the servlet name but before the query string, and translates it to a real path.">
	...
	<cffunction access="public" returntype="String" name="getProtocol" output="false"
	            hint="Returns the name and version of the protocol the request uses in the form protocol/majorVersion.minorVersion, for example, HTTP/1.1.">
	...
	<cffunction access="public" returntype="any" name="getReader" output="false"
	            hint="A java.io.BufferedReader containing the body of the request. Note that this reader may contain attacks and the developer is responsible for canonicalizing, validating, and encoding any data from this stream.">
	...
	<cffunction access="public" returntype="String" name="getRemoteAddr" output="false"
	            hint="Returns the IP address of the client or last proxy that sent the request.">
	...
	<cffunction access="public" returntype="String" name="getRemoteUser" output="false"
	            hint="Returns the name of the ESAPI user associated with this getHttpServletRequest().">
	...
	<cffunction access="public" returntype="any" name="getRequestDispatcher" output="false"
	            hint="java.servlet.RequestDispatcher: Checks to make sure the path to forward to is within the WEB-INF directory and then returns the dispatcher. Otherwise returns null.">
	...
	<cffunction access="public" returntype="String" name="getRequestedSessionId" output="false"
	            hint="Returns the SessionId from the HttpServletRequest after canonicalizing and filtering out any dangerous characters. Code must be very careful not to depend on the value of a requested session id reported by the user.">
		<cfset var local = {}/>
	...
	<cffunction access="public" returntype="any" name="getRequestURL" output="false"
	            hint="java.lang.StringBuffer: The currect request URL">
		<cfset var local = {}/>
		...
		<cfscript>
			...
			return newComponent("cfesapi.org.owasp.esapi.lang.StringBuilder").init(local.clean);
		</cfscript>
	...
	<cffunction access="public" returntype="any" name="getSession" output="false"
	            hint="cfesapi.org.owasp.esapi.HttpSession: Returns a session, creating it if necessary, and sets the HttpOnly flag on the Session ID cookie.">
		...
		<cfscript>
			...
			if(!structKeyExists(local, "jsession")) {
				return;
			}

			local.session = newComponent("cfesapi.org.owasp.esapi.filters.SecurityWrapperSession").init(instance.ESAPI, local.jsession);
	...
	<cffunction access="public" returntype="any" name="getUserPrincipal" output="false"
	            hint="Returns the ESAPI User associated with this getHttpServletRequest().">
	...
	<cffunction access="public" returntype="boolean" name="isRequestedSessionIdFromCookie" output="false"
	            hint="if requested session id is from a cookie">
	...
	<cffunction access="public" returntype="boolean" name="isRequestedSessionIdFromURL" output="false"
	            hint="Whether the requested session id is from the URL">
	...
	<cffunction access="public" returntype="boolean" name="isRequestedSessionIdValid" output="false"
	            hint="Whether the requested session id is valid">
	...
	<cffunction access="public" returntype="boolean" name="isSecure" output="false"
	            hint="Whether the current request is secure">
	...
	<cffunction access="public" returntype="boolean" name="isUserInRoleESAPI" output="false"
	...
	<cffunction access="public" returntype="void" name="setAllowableContentRoot" output="false">
		...
		<cfscript>
			if(arguments.allowableContentRoot.startsWith("/")) {
				instance.allowableContentRoot = arguments.allowableContentRoot;
			}
			else {
				instance.allowableContentRoot = "/" & arguments.allowableContentRoot;
			}
