...
<cffunction access="private" returntype="binary" name="newByte" outuput="false">
	...
	<cfscript>
		...
		local.sb.setLength(javaCast("int", arguments.len));
		return local.sb.toString().getBytes();
	</cfscript>
...
<cfscript>
	...
	*/
	...
	secretKey = createObject("component", "cfesapi.org.owasp.esapi.crypto.CryptoHelper").generateSecretKeyESAPI(encryptAlgorithm, encryptionKeyLength);
