...
<cfcomponent implements="org.owasp.esapi.User" extends="org.owasp.esapi.util.Object" output="false" hint="Reference implementation of the User interface. This implementation is serialized into a flat file in a simple format.">
	...
	<cffunction access="public" returntype="DefaultUser" name="init" output="false" hint="Instantiates a new user.">
	...
	<cffunction access="public" returntype="void" name="addRole" output="false">
		...
		<cfscript>
			...
			if(variables.ESAPI.validator().isValidInput( "addRole", roleName, "RoleName", variables.MAX_ROLE_LENGTH, false )) {
				...
				variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Role " & roleName & " added to " & getAccountName() );
			}
			else {
	...
	<cffunction access="public" returntype="void" name="disable" output="false">
		<cfscript>
			variables.enabled = false;
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Account disabled: " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="enable" output="false">
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Account enabled: " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setFailedLoginCount" output="false" hint="Set the failed login count">
	...
	<cffunction access="public" returntype="void" name="lock" output="false">
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Account locked: " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="loginWithPassword" output="false">
		...
		<cfscript>
			...
			if(verifyPassword( arguments.password )) {
				...
				variables.logger.trace( getSecurity("SECURITY_SUCCESS"), true, "User logged in: " & variables.accountName );
			}
			else {
	...
	<cffunction access="public" returntype="void" name="logout" output="false">
		<cfscript>
			...
			variables.loggedIn = false;
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Logout successful" );
	...
	<cffunction access="public" returntype="void" name="removeRole" output="false">
		...
		<cfscript>
			...
			variables.logger.trace( getSecurity("SECURITY_SUCCESS"), true, "Role " & arguments.role & " removed from " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setAccountName" output="false">
		...
		<cfscript>
			...
			if(old != "")
				variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Account name changed from " & old & " to " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setExpirationTime" output="false">
		...
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Account expiration time set to " & arguments.expirationTime & " for " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setLastFailedLoginTime" output="false">
		...
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Set last failed login time to " & arguments.lastFailedLoginTime & " for " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setLastLoginTime" output="false">
		...
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Set last successful login time to " & arguments.lastLoginTime & " for " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setLastPasswordChangeTime" output="false">
		...
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Set last password change time to " & arguments.lastPasswordChangeTime & " for " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setRoles" output="false">
		...
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Adding roles " & arrayToList( arguments.roles ) & " to " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="setScreenName" output="false">
		...
		<cfscript>
			...
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "ScreenName changed to " & arguments.screenName & " for " & getAccountName() );
		</cfscript> 
	</cffunction>
	...
	<cffunction access="public" returntype="void" name="unlock" output="false">
		<cfscript>
			variables.locked = false;
			variables.failedLoginCount = 0;
			variables.logger.info( getSecurity("SECURITY_SUCCESS"), true, "Account unlocked: " & getAccountName() );
		</cfscript> 
	</cffunction>
