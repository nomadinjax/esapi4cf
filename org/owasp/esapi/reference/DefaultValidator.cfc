...
<cfcomponent implements="org.owasp.esapi.Validator" extends="org.owasp.esapi.util.Object" output="false" hint="Reference implementation of the Validator interface. This implementation relies on the ESAPI Encoder, Java Pattern (regex), Date, and several other classes to provide basic validation functions. This library has a heavy emphasis on whitelist validation and canonicalization. All double-encoded characters, even in multiple encoding schemes, such as &amp;lt; or %26lt; or even %25%26lt; are disallowed.">
	...
	<cffunction access="public" returntype="boolean" name="isValidInput" output="false" hint="Returns true if data received from browser is valid. Only URL encoding is supported. Double encoding is treated as an attack.">
	...
	<cffunction access="public" returntype="boolean" name="isValidDate" output="false" hint="Returns true if input is a valid date according to the specified date format.">
	...
	<cffunction access="public" returntype="String" name="getValidDate" output="false" hint="Returns a valid date as a Date. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" name="format">
		<cfargument required="true" type="boolean" name="allowNull">
	...
	<cffunction access="public" returntype="boolean" name="isValidSafeHTML" output="false" hint="Returns true if input is 'safe' HTML. Implementors should reference the OWASP AntiSamy project for ideas on how to do HTML validation in a whitelist way, as this is an extremely difficult problem.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
	...
	<cffunction access="public" returntype="String" name="getValidSafeHTML" output="false" hint="Returns canonicalized and validated 'safe' HTML. Implementors should reference the OWASP AntiSamy project for ideas  on how to do HTML validation in a whitelist way, as this is an extremely difficult problem.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="numeric" name="maxLength">
		<cfargument required="true" type="boolean" name="allowNull">
	...
	<cffunction access="public" returntype="boolean" name="isValidCreditCard" output="false" hint="Returns true if input is a valid credit card. Maxlength is mandated by valid credit card type.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="boolean" name="allowNull">
		<cfscript>
	...
	<cffunction access="public" returntype="boolean" name="isValidDirectoryPath" output="false" hint="Returns true if the directory path (not including a filename) is valid. Note: On platforms that support symlinks, this function will fail canonicalization if directorypath is a symlink. For example, on MacOS X, /etc is actually /private/etc. If you mean to use /etc, use its real path (/private/etc), not the symlink (/etc).">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="boolean" name="allowNull">
		<cfscript>
	...
	<cffunction access="public" returntype="String" name="getValidDirectoryPath" output="false" hint="Returns a canonicalized and validated directory path as a String. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="boolean" name="allowNull">
		<cfargument type="org.owasp.esapi.ValidationErrorList" name="errorList">
	...
	<cffunction access="public" returntype="boolean" name="isValidFileName" output="false" hint="Returns true if input is a valid file name.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="boolean" name="allowNull">
		<cfscript>
	...
	<cffunction access="public" returntype="String" name="getValidFileName" output="false" hint="Returns a canonicalized and validated file name as a String. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="boolean" name="allowNull">
		<cfargument type="org.owasp.esapi.ValidationErrorList" name="errorList">
	...
	<cffunction access="public" returntype="boolean" name="isValidNumber" output="false" hint="Returns true if input is a valid number.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
	...
	<cffunction access="public" returntype="String" name="getValidNumber" output="false" hint="Returns a validated number as a double. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="numeric" name="minValue">
		<cfargument required="true" type="numeric" name="maxValue">
	...
	<cffunction access="public" returntype="boolean" name="isValidDouble" output="false" hint="Returns true if input is a valid number.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="numeric" name="minValue">
		<cfargument required="true" type="numeric" name="maxValue">
	...
	<cffunction access="public" returntype="String" name="getValidDouble" output="false" hint="Returns a validated number as a double. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="numeric" name="minValue">
		<cfargument required="true" type="numeric" name="maxValue">
	...
	<cffunction access="public" returntype="boolean" name="isValidInteger" output="false" hint="Returns true if input is a valid number.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="numeric" name="minValue">
		<cfargument required="true" type="numeric" name="maxValue">
	...
	<cffunction access="public" returntype="String" name="getValidInteger" output="false" hint="Returns a validated number as a double. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
		<cfargument required="true" type="numeric" name="minValue">
		<cfargument required="true" type="numeric" name="maxValue">
	...
	<cffunction access="public" returntype="boolean" name="isValidFileContent" output="false" hint="Returns true if input is valid file content.">
		<cfargument required="true" type="String" name="context">
	...
	<cffunction access="public" returntype="binary" name="getValidFileContent" output="false" hint="Returns validated file content as a byte array. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="binary" name="input">
		<cfargument required="true" type="numeric" name="maxBytes">
		<cfargument required="true" type="boolean" name="allowNull">
	...
	<cffunction access="public" returntype="boolean" name="isValidFileUpload" output="false" hint="Returns true if a file upload has a valid name, path, and content. Note: On platforms that support symlinks, this function will fail canonicalization if directorypath is a symlink. For example, on MacOS X, /etc is actually /private/etc. If you mean to use /etc, use its real path (/private/etc), not the symlink (/etc).">
		<cfargument required="true" type="String" name="context">
	...
	<cffunction access="public" returntype="boolean" name="isValidHTTPRequest" output="false" hint="Validates the current HTTP request by comparing parameters, headers, and cookies to a predefined whitelist of allowed characters. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
	...
	<cffunction access="public" returntype="void" name="assertIsValidHTTPRequest" output="false" hint="Validates the current HTTP request by comparing parameters, headers, and cookies to a predefined whitelist of allowed characters. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument name="httpRequest" default="#variables.ESAPI.httpUtilities().getCurrentRequest()#" hint="Defaults the current HTTPRequest saved in EASPI Authenticator">
		<cfscript>
			// CF8 requires 'var' at the top
			var parameters = "";
	...
	<cffunction access="public" returntype="boolean" name="isValidListItem" output="false" hint="Returns true if input is a valid list item.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="String" name="input">
	...
	<cffunction access="public" returntype="boolean" name="isValidHTTPRequestParameterSet" output="false" hint="Returns true if the parameters in the current request contain all required parameters and only optional ones in addition.">
		<cfargument required="true" type="String" name="context">
	...
	<cffunction access="public" returntype="void" name="assertIsValidHTTPRequestParameterSet" output="false" hint="Validates that the parameters in the current request contain all required parameters and only optional ones in addition. Invalid input will generate a descriptive ValidationException, and input that is clearly an attack will generate a descriptive IntrusionException.">
		<cfargument required="true" type="String" name="context">
		<cfargument required="true" type="Array" name="requiredNames">
		<cfargument required="true" type="Array" name="optionalNames">
		<cfargument type="org.owasp.esapi.ValidationErrorList" name="errorList">
	...
	<cffunction access="public" returntype="boolean" name="isValidPrintable" output="false" hint="Checks that all bytes are valid ASCII characters (between 33 and 126 inclusive). This implementation does no decoding. http://en.wikipedia.org/wiki/ASCII.">
		<cfargument required="true" type="String" name="context">
	...
	<cffunction access="private" returntype="boolean" name="isEmptyInput" output="false" hint="Helper function to check if a value is empty">
