...
<cfcomponent extends="org.owasp.esapi.util.Object" output="false" hint="ESAPI locator class is provided to make it easy to gain access to the current ESAPI classes in use. Use the set methods to override the reference implementations with instances of any custom ESAPI implementations.">
	...
	<cffunction access="public" returntype="org.owasp.esapi.util.HttpServletRequest" name="currentRequest" output="false" hint="Get the current HTTP Servlet Request being processed.">
		<cfscript>
	...
	<cffunction access="public" returntype="org.owasp.esapi.util.HttpServletResponse" name="currentResponse" output="false" hint="Get the current HTTP Servlet Response being generated.">
		<cfscript>
