 ...
 * @created 2008
 --->
<!---
 * ESAPI locator class is provided to make it easy to gain access to the current ESAPI classes in
use.
 * Use the set methods to override the reference implementations with instances of any custom ESAPI
implementations.
 --->
<cfcomponent extends="cfesapi.org.owasp.esapi.util.Object" output="false">

	<cfscript>
		instance.ESAPI = {accessController="", authenticator="", encoder="", encryptor="", executor="",
		           httpUtilities="",intrusionDetector="", logFactory="", defaultLogger="", randomizer="",
		           securityConfiguration="",validator=""};
	</cfscript>
	...
	<cffunction access="public" returntype="HttpServletRequest" name="currentRequest" output="false"
	...
	<cffunction access="public" returntype="HttpServletResponse" name="currentResponse" output="false"
	...
	<cffunction access="public" returntype="AccessController" name="accessController" output="false"
		...
		<cfscript>
			if(!isObject( instance.ESAPI.accessController ))
				instance.ESAPI.accessController = createObject( "component",
			                                        "cfesapi.org.owasp.esapi.reference.FileBasedAccessController" ).init( this );
	...
	<cffunction access="public" returntype="void" name="setAccessController" output="false"
		...
		<cfargument required="true" type="AccessController" name="accessController"
		            hint="the AccessController to set to be the current ESAPI AccessController. "/>
	...
	<cffunction access="public" returntype="Authenticator" name="authenticator" output="false"
		...
		<cfscript>
			if(!isObject( instance.ESAPI.authenticator ))
				instance.ESAPI.authenticator = createObject( "component",
			                                     "cfesapi.org.owasp.esapi.reference.FileBasedAuthenticator" ).init( this );
	...
	<cffunction access="public" returntype="void" name="setAuthenticator" output="false"
		...
		<cfargument required="true" type="Authenticator" name="authenticator"
		            hint="the Authenticator to set to be the current ESAPI Authenticator. "/>
	...
	<cffunction access="public" returntype="void" name="setEncoder" output="false"
		...
		<cfargument required="true" type="Encoder" name="encoder"
		            hint="the Encoder to set to be the current ESAPI Encoder."/>
	...
	<cffunction access="public" returntype="void" name="setEncryptor" output="false"
		...
		<cfargument required="true" type="Encryptor" name="encryptor"
		            hint="the Encryptor to set to be the current ESAPI Encryptor."/>
	...
	<cffunction access="public" returntype="void" name="setExecutor" output="false"
		...
		<cfargument required="true" type="Executor" name="executor"
		            hint="the Executor to set to be the current ESAPI Executor."/>
	...
	<cffunction access="public" returntype="HTTPUtilities" name="httpUtilities" output="false"
		...
		<cfscript>
			if(!isObject( instance.ESAPI.httpUtilities ))
				instance.ESAPI.httpUtilities = createObject( "component",
			                                     "cfesapi.org.owasp.esapi.reference.DefaultHTTPUtilities" ).init( this );
	...
	<cffunction access="public" returntype="void" name="setHttpUtilities" output="false"
		...
		<cfargument required="true" type="HTTPUtilities" name="httpUtilities"
		            hint="the HTTPUtilities object to set to be the current ESAPI HTTPUtilities object."/>
	...
	<cffunction access="public" returntype="IntrusionDetector" name="intrusionDetector" output="false"
		...
		<cfscript>
			if(!isObject( instance.ESAPI.intrusionDetector ))
				instance.ESAPI.intrusionDetector = createObject( "component",
			                                         "cfesapi.org.owasp.esapi.reference.DefaultIntrusionDetector" ).init( this );
	...
	<cffunction access="public" returntype="void" name="setIntrusionDetector" output="false"
		...
		<cfargument required="true" type="IntrusionDetector" name="intrusionDetector"
		            hint="the IntrusionDetector to set to be the current ESAPI IntrusionDetector."/>
	...
	<cffunction access="public" returntype="Logger" name="getLogger" output="false"
		...
		<cfargument required="true" type="String" name="moduleName"
		            hint="The module to associate the logger with."/>
	...
	<cffunction access="public" returntype="void" name="setLogFactory" output="false"
		...
		<cfargument required="true" type="LogFactory" name="factory"
		            hint="the LogFactory to set to be the current ESAPI LogFactory."/>
	...
	<cffunction access="public" returntype="Randomizer" name="randomizer" output="false"
		...
		<cfscript>
			if(!isObject( instance.ESAPI.randomizer ))
				instance.ESAPI.randomizer = createObject( "component",
			                                  "cfesapi.org.owasp.esapi.reference.DefaultRandomizer" ).init( this );
	...
	<cffunction access="public" returntype="void" name="setRandomizer" output="false"
		...
		<cfargument required="true" type="Randomizer" name="randomizer"
		            hint="the Randomizer to set to be the current ESAPI Randomizer."/>
	...
	<cffunction access="public" returntype="SecurityConfiguration" name="securityConfiguration"
	            output="false"
		...
		<cfscript>
			if(!isObject( instance.ESAPI.securityConfiguration ))
				instance.ESAPI.securityConfiguration = createObject( "component",
			                                             "cfesapi.org.owasp.esapi.reference.DefaultSecurityConfiguration" ).init( this );
	...
	<cffunction access="public" returntype="void" name="setSecurityConfiguration" output="false"
		...
		<cfargument required="true" type="SecurityConfiguration" name="securityConfiguration"
		            hint="the SecurityConfiguration to set to be the current ESAPI SecurityConfiguration."/>
	...
	<cffunction access="public" returntype="Validator" name="validator" output="false"
		...
		<cfscript>
			if(!isObject( instance.ESAPI.validator ))
				instance.ESAPI.validator = createObject( "component",
			                                 "cfesapi.org.owasp.esapi.reference.DefaultValidator" ).init( this );
	...
	<cffunction access="public" returntype="void" name="setValidator" output="false"
		...
		<cfargument required="true" type="Validator" name="validator"
		            hint="the Validator to set to be the current ESAPI Validator."/>
