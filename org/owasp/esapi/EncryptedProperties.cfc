...
<cfinterface hint="The EncryptedProperties interface represents a properties file where all the data is encrypted before it is added, and decrypted when it retrieved. This interface can be implemented in a number of ways, the simplest being extending Properties and overloading the getProperty and setProperty methods.">
	...
	<cffunction access="public" returntype="String" name="getProperty" output="false"
	            hint="Gets the property value from the encrypted store, decrypts it, and returns the plaintext value to the caller.">
	...
	<cffunction access="public" returntype="String" name="setProperty" output="false"
	            hint="Encrypts the plaintext property value and stores the ciphertext value in the encrypted store.">
	...
	<cffunction access="public" returntype="void" name="load" output="false"
	            hint="Reads a property list (key and element pairs) from the input stream.">
	...
	<cffunction access="public" returntype="void" name="store" output="false"
	            hint="Writes this property list (key and element pairs) in this Properties table to the output stream in a format suitable for loading into a Properties table using the load method.">
