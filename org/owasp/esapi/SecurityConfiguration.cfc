...
<cfinterface hint="The SecurityConfiguration interface stores all configuration information that directs the behavior of the ESAPI implementation. Protection of this configuration information is critical to the secure operation of the application using the ESAPI. You should use operating system access controls to limit access to wherever the configuration information is stored. Please note that adding another layer of encryption does not make the attackers job much more difficult. Somewhere there must be a master 'secret' that is stored unencrypted on the application platform. Creating another layer of indirection doesn't provide any real additional security. Its up to the reference implementation to decide whether this file should be encrypted or not. The ESAPI reference implementation (DefaultSecurityConfiguration.java) does not encrypt its properties file.">
	...
	<cffunction access="public" returntype="Array" name="getMasterPassword" output="false"
	            hint="Gets the master password. This password can be used to encrypt/decrypt other files or types of data that need to be protected by your application.">
	</cffunction>
	...
	<cffunction access="public" returntype="String" name="getEncryptionAlgorithm" output="false"
	            hint="Gets the encryption algorithm used by ESAPI to protect data.">
	</cffunction>
	...
	<cffunction access="public" name="getQuota" output="false"
	            hint="Gets the intrusion detection quota for the specified event.">
	...
	<cffunction access="public" returntype="String" name="getResourceDirectory" output="false"
	            hint="Gets the name of the ESAPI resource directory as a String.">
	</cffunction>
	...
	<cffunction access="public" returntype="boolean" name="getLogDefaultLog4J" output="false"
	            hint="As a backwards compatibility measure, the allows the default logging class to be log4j. This will eventually migrate to the ESAPI 2.0 configuration mechanism where any class with the right interface can be configured in ESAPI.properties.">
	</cffunction>

	<cffunction access="public" returntype="numeric" name="getLogLevel" output="false"
	            hint="Get the log level specified in the ESAPI configuration properties file. Return a default value if it is not specified in the properties file.">
	</cffunction>
