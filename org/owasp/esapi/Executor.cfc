...
interface {
	 ...
	 */
	public ExecuteResult function executeSystemCommand(required executable, required List params, workdir, codec, boolean logParams, boolean redirectErrorStream);
