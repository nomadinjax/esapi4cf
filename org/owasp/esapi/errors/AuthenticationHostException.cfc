 ...
 * @created 2011
 */ --->
<cfcomponent displayname="AuthenticationHostException" extends="AuthenticationException" output="false" hint="An AuthenticationHostException should be thrown when there is a problem with the host involved with authentication, particularly if the host changes unexpectedly.">
