 ...
 * @created 2011
 */ --->
<cfcomponent displayname="CertificateException" extends="EnterpriseSecurityException" output="false" hint="A CertificateException should be thrown for any problems that arise during processing of digital certificates.">

	<cffunction access="public" returntype="CertificateException" name="init" output="false"
	            hint="Instantiates a new CertificateException.">
