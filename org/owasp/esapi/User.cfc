...
<cfinterface extends="org.owasp.esapi.util.Principal" hint="The User interface represents an application user or user account. There is quite a lot of information that an application must store for each user in order to enforce security properly. There are also many rules that govern authentication and identity management. A user account can be in one of several states. When first created, a User should be disabled, not expired, and unlocked. To start using the account, an administrator should enable the account. The account can be locked for a number of reasons, most commonly because they have failed login for too many times. Finally, the account can expire after the expiration date has been reached. The User must be enabled, not expired, and unlocked in order to pass authentication.">
	...
	<cffunction access="public" returntype="void" name="addRoles" output="false"
	            hint="Adds a set of roles to this user's account.">
	...
	<cffunction access="public" returntype="void" name="changePassword" output="false"
	            hint="Sets the user's password, performing a verification of the user's old password, the equality of the two new passwords, and the strength of the new password.">
	...
	<cffunction access="public" returntype="void" name="removeSession" output="false"
	            hint="Removes a session for this User.">
	...
	<cffunction access="public" returntype="void" name="setExpirationTime" output="false"
	            hint="Sets the date and time when this user's account will expire.">
	...
	<cffunction access="public" returntype="void" name="setRoles" output="false"
	            hint="Sets the roles for this account.">
	...
	<cffunction access="public" returntype="void" name="setScreenName" output="false"
	            hint="Sets the screen name (username alias) for this user.">
	...
	<cffunction access="public" returntype="void" name="setLastFailedLoginTime" output="false"
	            hint="Set the time of the last failed login for this user.">
	...
	<cffunction access="public" returntype="void" name="setLastHostAddress" output="false"
	            hint="Set the last remote host address used by this user.">
	...
	<cffunction access="public" returntype="void" name="setLastLoginTime" output="false"
	            hint="Set the time of the last successful login for this user.">
	...
	<cffunction access="public" returntype="void" name="setLastPasswordChangeTime" output="false"
	            hint="Set the time of the last password change for this user.">
